...
constructor(
    ...
    data class Builder(
        ...
        fun dislikedIngredients(dislikedIngredients: List<String>) =
            apply { this.dislikedIngredients = dislikedIngredients }

        fun allergies(allergies: List<String>) = apply { this.allergies = allergies }
        fun dietaryPreferences(dietaryPreferences: List<String>) =
            apply { this.dietaryPreferences = dietaryPreferences }
